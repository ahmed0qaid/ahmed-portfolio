...
const engineeringSkills = [
  { groupAr: "Backend & Systems", groupEn: "Backend & Systems", items: ["Python", "PHP", "Go", "C++20", "FastAPI", "Flask", "Laravel", "REST APIs", "SQLAlchemy"] },
  { groupAr: "Databases & Data", groupEn: "Databases & Data", items: ["SQL", "PostgreSQL", "MySQL", "SQL Server", "SQLite", "Supabase", "Prisma", "Data Modeling", "Migrations"] },
  { groupAr: "Cloud & Infrastructure", groupEn: "Cloud & Infrastructure", items: ["Docker", "Docker Compose", "GitHub Actions", "CI/CD", "Redis", "Vercel", "Environment Config", "n8n"] },
  { groupAr: "Distributed Systems & Reliability", groupEn: "Distributed Systems & Reliability", items: ["Durable Execution", "Worker Leases", "Heartbeats", "Retry / Backoff", "Idempotency", "Concurrency", "Crash Recovery"] },
  { groupAr: "AI & Agent Infrastructure", groupEn: "AI & Agent Infrastructure", items: ["MCP", "AI Agents", "LLM Integrations", "Policy Engines", "Human Approvals", "OpenTelemetry", "Trajectory Tracing"] },
  { groupAr: "Web & Mobile Product Engineering", groupEn: "Web & Mobile Product Engineering", items: ["React", "Next.js", "TypeScript", "JavaScript", "HTML", "CSS", "Flutter", "Dart", "Responsive UI"] },
];
